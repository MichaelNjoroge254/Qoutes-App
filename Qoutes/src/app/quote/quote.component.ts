...
export class QuoteComponent implements OnInit {
  ...
  public quotes: Quote[] = [
    ...
    new Quote('Letting go means to come to the realization that some people are a part of your history, but not a part of your destiny.', 'Steve Maraboli', 'Stew', new Date(2021, 5, 21)),
